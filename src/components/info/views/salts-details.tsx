...
export interface SaltsDetailsProps {

    data: MedicineDetails
}

const SaltsDetails: React.FC<SaltsDetailsProps> = ({ data }) => {
        ...
        <div className='flex flex-col gap-4 w-full rounded-md p-4 border border-gray-500 bg-[#1F222E]'>
            ...
            <div className="flex justify-between">
                <div className="flex flex-col gap-0.5">
                    <span className='text-2xl font-semibold tracking-wide'>{data?.salt}</span>
                ...
                <div className="flex rounded-md px-4 py-2 bg-blue-200 h-fit text-sm font-semibold">
                    <span className='text-blue-900'>Salt</span>
                </div>
            </div>
